...
def parse_date(raw_date):
    ...
    # e.g. "11 мин өмнө" (MASS.mn), "3 цагийн өмнө", "5 өдрийн өмнө"
    rel_match = re.match(r'^\s*(\d+)\s*(?:цагийн\s*(?:өмнө|урьд)|цаг|өдрийн\s*(?:өмнө|урьд)|өдөр|хоногийн\s*(?:өмнө|урьд)|хоног|долоо\s*хоногийн\s*(?:өмнө|урьд)|долоо\s*хоног\S*\s*(?:өмнө|урьд)|долоо\s*хоног|сарын\s*(?:өмнө|урьд)|сар|жилийн\s*(?:өмнө|урьд)|жил|минутын\s*(?:өмнө|урьд)|минут\s*(?:өмнө|урьд)|мин\s*(?:өмнө|урьд)|минут|мин)\s*$', raw_date)
    if rel_match:
